...
const resources = {
  ...
  ar: {
    translation: {
      ...
      "monthly": "شهري",
      "yearly": "سنوي",
      "Overall budget has expired": "انتهت الميزانية العامة",
      "The period for your active budget has ended. You can remove it or set a new one.": "انتهت الفترة المخصصة لميزانيتك الحالية. يمكنك إزالتها أو تعيين ميزانية جديدة.",
      "Delete income?": "حذف الدخل؟",
      "Set New Budget": "تعيين ميزانية جديدة",
      "Category Budget Expired": "انتهت ميزانية الفئة",
      "No incomes found": "لم يتم العثور على دخل",
      "The budget for": "انتهت ميزانية",
      "has ended and will no longer track new expenses. You can replace it in the": "ولن يتم تتبع المصروفات الجديدة. يمكنك استبدالها في صفحة",
      "Category Budgets page.": "ميزانيات الفئات",
      "page.": "صفحة.",
